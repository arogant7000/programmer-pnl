...
@section('content')
  <section id="hero" class="hero-big parallax-section" data-parallax-image="files/uploads/hero-about-3.jpg">

        <div id="page-title" class="wrapper title-bottom">
          <h4><strong>Hello, I'm Jhon Florence</strong></h4>
